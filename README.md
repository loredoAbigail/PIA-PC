...
Examina registros simulados de accesos exitosos y fallidos, detectando patrones anómalos como múltiples intentos fallidos desde la misma IP o comportamientos que puedan indicar ataques de fuerza bruta.
...
El proyecto busca fomentar buenas prácticas de ciberseguridad, especialmente en la detección temprana de intrusiones y la protección de sistemas de autenticación.
