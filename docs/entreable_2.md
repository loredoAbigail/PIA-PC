...
> [Ejemplos de datos utilizados, formatos aceptados, cómo se proporcionan al script.]
 
---
 
##  Salidas generadas
 
> [Ejemplos de archivos generados: findings.csv, alerts.jsonl, executive_summary.md, etc.]
